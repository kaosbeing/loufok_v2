                ...
                <div class="form__element">
                    ...
                    <div class="password__wrapper input--custom-style">
                        ...
                        <label class="form__checkbox">
                            ...
                            <svg class="eye eye--hide" aria-label="Cacher le mot de passe" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg class="eye eye--visible" aria-label="Montrer le mot de passe" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
