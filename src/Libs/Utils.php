...
?>
        <header class="header">
            ...
            <a href="<?php echo $returnLink ?>" class="header__homelink">
                <img src="<?php echo APP_ROOT_URL_COMPLETE ?>/assets/medias/images/logotype_white.svg" alt="Logotype" class="header__logotype">
            </a>
            <a href="<?php echo APP_ROOT_URL_COMPLETE ?>/logout" class="header__logoutlink">
