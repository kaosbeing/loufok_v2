...
?>
    ...
    ?>
        <link rel="preload" href="<?php echo APP_ASSETS_URL ?>/medias/images/favicon.svg" as="image" type="image/svg+xml">
        <link rel="icon" href="<?php echo APP_ASSETS_URL ?>/medias/images/favicon.svg" type="image/svg+xml">
        <link rel="icon" href="<?php echo APP_ASSETS_URL ?>/medias/images/favicon.png" type="image/png">
    <?php
    }
    ...
    ?>
        <link rel="stylesheet" href="<?php echo APP_ASSETS_URL ?>/css<?php echo DS . $name ?>.css">
    <?php
    }
    ...
    ?>
        <script src="<?php echo APP_ASSETS_URL ?>/scripts/<?php echo $script ?>.js" defer></script>
    <?php
    }
    ...
    ?>
        <link rel="manifest" href="<?php echo APP_ASSETS_URL ?>/loufok.webmanifest">
<?php
    }
}
?>